...
build/main.o: src/main.cpp include/system.hpp 
	$(CXX) -c $< -o $@
build/system.o: src/system.cpp include/card.hpp include/peashooter.hpp include/sunflower.hpp include/walnut.hpp include/sunshine.hpp include/scoreBox.hpp include/icePeashooter.hpp include/zombie.hpp include/attackingPlant.hpp include/bullet.hpp
	$(CXX) -c $< -o $@
